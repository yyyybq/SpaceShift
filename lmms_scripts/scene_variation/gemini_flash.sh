...
# Google AI Studio exposes this model as `gemini-3-flash-preview`.
MODEL_VERSION="${MODEL_VERSION:-gemini-3-flash-preview}"
TASK_NAME="${TASK_NAME:-scene_variation}"
OUTPUT_DIR="${OUTPUT_DIR:-/nas2/edwin/lmms-eval/results/gemini_3_flash_preview_with_thinking_full_benchmark}"
...
$PYTHON -m lmms_eval \
    ...
    --log_samples \
    --log_samples_suffix gemini_3_flash_preview_full_benchmark \
